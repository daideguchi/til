...
contract Dex {
    ...
    event buy(address account, address _tokenAddr, uint256 _cost, uint _amount);
    event sell(address account, address _tokenAddr, uint256 _cost, uint _amount);
